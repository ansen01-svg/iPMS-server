// src/utils/generateProjectSummaryPDF.js
...
export const generateProjectSummaryPDF = async (
  ...
  try {
    ...
    const basicInfo = [
      ["Project Name:", projectData.nameOfWork || "N/A"],
      ["Contractor:", projectData.nameOfContractor || "N/A"],
      ["Financial Year:", projectData.financialYear || "N/A"],
      ["Work Value:", formatCurrency(projectData.workValue)],
      ["Location:", projectData.location || "N/A"],
      ["Concerned Engineer:", projectData.concernedEngineer || "N/A"],
      ["A.A. Number:", projectData.AANumber || "N/A"],
      ["A.A. Amount:", formatCurrency(projectData.AAAmount)],
      ["A.A. Date:", formatDate(projectData.AADated)],
      ["FWO Details:", projectData.FWONumberAndDate || "Not specified"],
      ["FWO Date:", formatDate(projectData.FWODate)],
    ];
    ...
    const financialProgressInfo = [
      ...
      [
        "Amount Remaining:",
        formatCurrency(projectData.remainingWorkValue || projectData.workValue),
      ],
      [
        "Last Updated:",
    ...
    if (metrics && Object.keys(metrics).length > 0) {
      ...
      const metricsInfo = [
        ...
        [
          "Days from AA to FWO:",
          metrics.daysFromAAToFWO ? `${metrics.daysFromAAToFWO} days` : "N/A",
        ],
        [
          "Days from FWO to Now:",
          metrics.daysFromFWOToNow ? `${metrics.daysFromFWOToNow} days` : "N/A",
        ],
