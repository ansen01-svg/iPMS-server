...
import { generateProjectSummaryPDF } from "../../utils/project-summary-pdf-generator.js";

/**
 * Generate and download project summary PDF with progress updates
 * GET /api/projects/:id/download-summary-pdf
 */
export const generateProjectSummaryPDFController = async (req, res) => {
  try {
    ...
    const remainingWorkValue = project.remainingBudget;
    ...
    const projectMetrics = {
      ...
      billSubmissionRate:
        project.estimatedCost > 0
          ...
          : 0,
      isPhysicallyOverdue:
        (project.progressPercentage || 0) < 100 && project.projectEndDate
 ...
 * GET /api/projects/:id/pdf-options
 */
 ...
 * POST /api/projects/bulk/generate-summary-pdf
 */
  ...
  try {
    ...
    for (const project of projects) {
      try {
        ...
        const enrichedProject = {
          ...project.toJSON(),
          remainingWorkValue: project.remainingBudget,
